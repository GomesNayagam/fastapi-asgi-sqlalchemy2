FROM atm-base.artifactory.teslamotors.com/python:3.11-bookworm as requirements-stage

RUN pip install poetry
COPY ./pyproject.toml ./poetry.lock /
RUN poetry export -f requirements.txt --output requirements.txt --without-hashes --without=dev

FROM atm-base.artifactory.teslamotors.com/python:3.11-bookworm-slim
